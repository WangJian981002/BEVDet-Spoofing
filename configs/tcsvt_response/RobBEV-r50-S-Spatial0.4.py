...
img_pre_weight = 'work_dirs/FINISHED/LidarSys-bevdet4d-8Frame-r50-cbgs-mAP.3464-NDS.4803/epoch_15.pth'
...
'''
load_from = 'work_dirs/RobBEV-r50-S-Spatial0.4-mAP.6873-NDS.7196/epoch_9.pth'
# Optimizer
optimizer = dict(type='AdamW', lr=5e-5, weight_decay=0.01)
optimizer_config = dict(grad_clip=dict(max_norm=10, norm_type=2))
lr_config = dict(
