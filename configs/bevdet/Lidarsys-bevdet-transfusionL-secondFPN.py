...
load_img_from='checkpoints/mask_rcnn_r50_fpn_2x_coco_bbox_mAP-0.392__segm_mAP-0.354_20200505_003907-3e542a40.pth'
model = dict(
    type='BEVDet_tf',
    img_backbone=dict(
...
test_pipeline = [
    dict(type='PrepareImageInputs', data_config=data_config, is_train=False),
    dict(
        type='LoadAnnotationsBEVDepth',
        bda_aug_conf=bda_aug_conf,
        classes=class_names,
