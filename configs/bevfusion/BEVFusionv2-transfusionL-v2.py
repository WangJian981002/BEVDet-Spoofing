...
numC_Trans = 80
img_pre_weight = 'work_dirs/LidarSys-bevdet-woBEVEncoder-transfusionL-res50-cbgs-spatial_0.6/epoch_20.pth'
...
test_pipeline = [
    ...
    dict(
        ...
        pad_empty_sweeps=True,
        remove_close=True),
    dict(type='PrepareImageInputsv2', data_config=data_config, opencv_pp=True, is_train=False),
    dict(
        type='LoadAnnotationsBEVDepth',
        bda_aug_conf=bda_aug_conf,
        classes=class_names,
...
# Optimizer
optimizer = dict(type='AdamW', lr=5e-5, betas=(0.9, 0.999), weight_decay=0.05, paramwise_cfg=dict(
