...
class NuScenesDataset(Custom3DDataset):
    ...
    def __init__(self,
        ...
        for i in range(len(self.data_infos)):
            ...
            #if 'Rain' not in scene_i['description'] and 'rain' not in scene_i['description']: #sunny
            if 'Rain' in scene_i['description'] or 'rain' in scene_i['description']:  # rainy
            #if 'Night' not in scene_i['description'] and 'night' not in scene_i['description']:  # day
            #if 'Night' in scene_i['description'] or 'night' in scene_i['description']:  # night
