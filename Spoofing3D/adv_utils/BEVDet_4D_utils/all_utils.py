...
def maskGT_put_poster_on_batch_inputs_4D(leaning_poster, batch_inputs, spoof_cams=['CAM_FRONT', 'CAM_BACK'], is_bilinear=False, num_adj=8):
...
def put_poster_on_batch_inputs_eval_4D(leaning_poster, batch_inputs, spoof_cams=['CAM_FRONT', 'CAM_BACK'], num_adj=8):
